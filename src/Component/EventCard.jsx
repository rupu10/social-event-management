...
const EventCard = ({event}) => {
  ...
  <figure>
    <img
      src= {thumbnail}
      className='max-h-[250px] md:max-h-[300px] w-full md:min-h-[300px]'
      alt="Shoes" />
  </figure>
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
      <Link className='w-full' to={`/events/${_id}`}><button className="btn btn-all w-full">View Details</button></Link>
    </div>
  </div>
</div>
    );
